...
import { ArrowLeft, Plus, Search, Filter, Eye, Edit3, Trash2, MoreHorizontal, Calendar, TrendingUp } from 'lucide-react'
    ...
    try {
      ...
      setPosts([
        ...
        },
        {
          ...
          summary: "How to leverage analytics and user research to make informed design decisions that users love.",
          status: "draft",
          views: 0,
          likes: 0,
          comments: 0,
        ...
        },
        {
          ...
          summary: "Exploring emerging trends in frontend development and what's coming next.",
          status: "draft",
          views: 0,
          likes: 0,
          comments: 0,
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div style={{ 
              ...
              {sortedPosts.map((post, index) => (
                <div 
                  ...
                  style={{ 
                    padding: '24px',
                    borderBottom: index < sortedPosts.length - 1 ? '1px solid var(--gray-100)' : 'none'
                  }}
                >
                  <div className="flex items-start justify-between">
                    <div style={{ flex: 1 }}>
                      <div className="flex items-center gap-3 mb-3">
                        <span 
                          ...
                          style={{
                            ...
                            color: post.status === 'published' ? '#059669' : '#92400e',
                            fontSize: '12px',
                            padding: '4px 8px',
                            fontWeight: '500'
                          }}
                      ...
                      {post.status === 'published' && (
                        <div className="flex items-center gap-6" style={{ fontSize: '14px', color: 'var(--gray-500)' }}>
          ...
          {sortedPosts.length > 0 && (
            <div style={{ 
              ...
              <div className="flex items-center justify-center gap-8" style={{ fontSize: '14px', color: 'var(--gray-600)' }}>
                <div>
                ...
                <div>
                  <span style={{ fontWeight: '600', color: 'var(--black)' }}>
                    {formatNumber(sortedPosts.reduce((sum, post) => sum + post.views, 0))}
                  </span> total views
                </div>
                <div>
                  <span style={{ fontWeight: '600', color: 'var(--black)' }}>
